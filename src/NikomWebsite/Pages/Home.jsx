        ...
        <div className="bg-[url('./img/banner-bg1.jpg')] bg-cover bg-no-repeat relative xl:h-screen h-[500px]">
            <div className='container'>
                <div className='absolute xl:top-44 top-3 xl:left-32 left-3 xl:w-[40%] w-full xl:py-0 py-2  xl:px-0 px-4'>
                    ...
                    <p className='text-slate-50 text-[17px] mb-4'>A new paradigm of Digital led converged technologies and connected experiences await your business processes. With Advanced & Accelerated Platform-led Transformation to ADAPT to a new digital era.</p>
