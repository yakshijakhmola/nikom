      ...
      <div className="banner xl:h-screen h-[500px]">
        <div className='container'>
          <div className='absolute xl:top-44 top-3 xl:left-32 left-3 xl:w-[50%] w-full xl:py-0 py-2  xl:px-0 px-4'>
            ...
            <a onClick={()=>navigate('/contact')} className='dark-btn bg-darkred' data-aos="fade-up" data-aos-delay="200" data-aos-duration="2000">Contact Us<FaArrowRight className='circle'/> </a>
          </div>
        </div>
      </div>
    </>
